    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default" style="background-color:lightgrey ;">
                <div class="panel-body" style="border:3px solid  #0000ff;border-radius:8px;">
                    <div class="col-xs-4">
                        <a href="#" style="font-size:28px;color:  #0000ff">Link Sharing</a>
                    </div>
                    <div class="col-xs-3">
...
<div class="col-xs-5">
    <g:if test="${session.user}">
        ...
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal14"
                style="border:none;background:none;">
    ...
    <div class=" pull-right"><div class="dropdown" style="color: #366EE0;">
        <button class="btn btn-default dropdown-toggle " type="button" id="dropdownMenu1"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"
                style="border:none;color: #366EE0;"><div class="glyphicon glyphicon-user"
                                                         style="font-size:40px;color: #366EE0;"></div>
