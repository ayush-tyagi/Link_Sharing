            ...
            <div class="modal-body">
                <g:form class="form-horizontal" controller="topic" action="save">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                     <g:actionSubmit class="form-control btn btn-default active" value="save" id="submit" formaction="/LinkSharing/topic/save" type="button" name="submit">
                     </g:actionSubmit>
                        ...
                        <input type="button" class="form-control btn btn-default active" id="cancel" name="cancel" value="cancel" placeholder="Cancel" style="color:black;border:solid black;border-radius:7px">
                    </div>
                    </div>
