            ...
            <div class="modal-body">
                ...
                <g:uploadForm class="form-horizontal" controller="documentResource" action="save" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <g:select class="btn dropdown-toggle" data-toggle="dropdown" name="topic" style="width:200px;" from="${subscribedTopics}" optionKey="id"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <g:submitButton value="save" type="submit" name="submit"
                                            class="form-control btn btn-default active"
                                             id="submit" placeholder="Share"
